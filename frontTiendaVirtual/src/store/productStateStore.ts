...
const initialState: ProductState = {
  ...
  order: "desc",
  price: "",
  requestFindProduct: false,
};

/**
 * Hook de Zustand para manejar el estado de la busqueda de producto
 */
export const useProductStateStore = create<ProductState & Action>()(
  (set, get) => ({
    ...initialState,
    ...
    onRequestFindProduct() {
        set({ requestFindProduct: !get().requestFindProduct })
    },
  })
);
